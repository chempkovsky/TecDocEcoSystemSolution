// CarShop.Controllers.ReturnBasketController
...
namespace CarShop.Controllers
{
    ...
    public class ReturnBasketController : Controller
    {
        ...
        public async Task<ActionResult> Index(Guid? searchEntGuid = default(Guid?), Guid? searchEntBranchGuid = default(Guid?), string searchEntUserNic = null, int? showIsActive = default(int?), int? showIsPaid = default(int?), int? showIsReverse = default(int?), int? currentIsActive = default(int?), int? currentIsPaid = default(int?), int? currentIsIsReverse = default(int?), int? page = default(int?))
        {
            ...
            if ((!base.ViewBag.IsEcoSystemAdmin))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!base.ViewBag.IsBranchAudit || searchEntUserNic == null)
                        {
            ...
            IPagedList<ReturnBasketTDES> aResult = null;
            ...
            if (CarShopSalesContextCatalog != null)
            {
                ...
                {
                    IQueryable<ReturnBasketTDES> salebaskettdes2 = from e in dbSales.ReturnBasketTDES
        ...
        public async Task<ActionResult> Details(Guid? searchEntBasketGuid = default(Guid?), Guid? searchEntGuid = default(Guid?), Guid? searchEntBranchGuid = default(Guid?))
        {
            ...
            if (CarShopSalesContextCatalog != null)
            {
                salebaskettdes = ((!((!base.ViewBag.IsEcoSystemAdmin) ? true : false)) ? (await (from e in dbSales.ReturnBasketTDES
                                                                                                 where (Guid)(Guid?)e.RetBasketGuid == (Guid)searchEntBasketGuid
                                                                                                 select e).FirstOrDefaultAsync()) : ((!((base.ViewBag.IsEnterpriseAdmin || base.ViewBag.IsEnterpriseAudit) ? true : false)) ? (await (from e in dbSales.ReturnBasketTDES
                                                                                                                                                                                                                                      where (Guid)(Guid?)e.RetBasketGuid == (Guid)searchEntBasketGuid && (Guid)(Guid?)e.EntGuid == (Guid)searchEntGuid && (Guid)(Guid?)e.EntBranchGuid == (Guid)searchEntBranchGuid && e.EntUserNic == searchEntUserNic
                                                                                                                                                                                                                                      select e).FirstOrDefaultAsync()) : (await (from e in dbSales.ReturnBasketTDES
                                                                                                                                                                                                                                                                                 where (Guid)(Guid?)e.RetBasketGuid == (Guid)searchEntBasketGuid && (Guid)(Guid?)e.EntGuid == (Guid)searchEntGuid
                                                                                                                                                                                                                                                                                 select e).FirstOrDefaultAsync())));
            }
        ...
        [HttpPost]
        [Authorize(Roles = "EcoSystemAdmin,EnterpriseAdmin,BranchAdmin,BranchSeller,BranchBooker")]
        public async Task<ActionResult> Create(ReturnBasketTDES salebaskettdes)
        {
            UserIsInRoles();
            Guid? searchEntGuid;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(ReturnBasketTDES salebaskettdes)
        {
            UserIsInRoles();
            Guid? searchEntGuid;
            Guid? searchEntBranchGuid;
            ...
            if (base.ModelState.IsValid && salebaskettdes.IsActive)
            {
                foreach (ReturnBasketTDES item in await (from e in dbSales.ReturnBasketTDES
                                                         ...
                                                         select e).ToListAsync())
                {
                    if (salebaskettdes.RetBasketGuid != item.RetBasketGuid)
                    {
                        item.IsActive = false;
                        dbSales.Entry(item).State = EntityState.Modified;
                    }
            ...
            if (base.ModelState.IsValid)
            {
                ReturnBasketTDES loc = dbSales.ReturnBasketTDES.Local.FirstOrDefault((ReturnBasketTDES e) => e.RetBasketGuid == salebaskettdes.RetBasketGuid);
                if (loc != null)
                {
        ...
        public async Task<ActionResult> DeleteConfirmed(Guid? searchEntBasketGuid = default(Guid?), Guid? searchEntGuid = default(Guid?), Guid? searchEntBranchGuid = default(Guid?))
        {
            ...
            if (salebaskettdes != null)
            {
                ...
                dbSales.ReturnBasketTDES.Remove(salebaskettdes);
                await dbSales.SaveChangesAsync();
                return RedirectToAction("Index", new
                {
                    searchEntGuid = salebaskettdes.EntGuid,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> MakePayment(Guid? searchRetBasketGuid = default(Guid?), Guid? searchEntGuid = default(Guid?), Guid? searchEntBranchGuid = default(Guid?))
        {
            UserIsInRoles();
            string searchEntUserNic = null;
            if ((!base.ViewBag.IsEcoSystemAdmin))
            ...
            if (CarShopSalesContextCatalog != null)
            {
                salebaskettdes = await (from e in dbSales.ReturnBasketTDES.Include("ReturnBasketArticleTDES")
            ...
            if (salebaskettdes.IsPaid)
            {
                base.ModelState.AddModelError("", Resources.ReturnBasketTDES_ISPAYED);
                return View("Details", salebaskettdes);
            }
            ...
            List<ReturnBasketArticleTDES> Items = salebaskettdes.ReturnBasketArticleTDES.ToList();
            foreach (ReturnBasketArticleTDES Item in Items)
            {
                if (!Item.IsPaid)
                {
                    if (Item.ArtAmount < 1)
                    ...
                    {
                        SaleBasketArticleTDES salebasketarticleTDES = await (from e in dbSales.SaleBasketArticleTDES
                                                                             where e.EntArticle == Item.EntArticle && e.EntBrandNic == Item.EntBrandNic && e.EntBasketGuid == Item.EntBasketGuid
                                                                             select e).FirstOrDefaultAsync();
                        if (salebasketarticleTDES == null)
                        {
                            base.ModelState.AddModelError("", Resources.SaleBasket_NOTDEFINED + ":" + Item.EntArticle + ":" + Item.EntBrandNic + ":" + Item.EntBasketGuid);
                            return View("Details", salebaskettdes);
                        }
                        if (Item.ArtAmount > salebasketarticleTDES.ArtAmount - salebasketarticleTDES.ReverseAmount)
                        {
                            base.ModelState.AddModelError("", Resources.ReturnBasketTDES_AMOUNTINCORRECT + ":" + Item.EntArticle + ":" + Item.EntBrandNic + ":" + Item.EntBasketGuid);
                            return View("Details", salebaskettdes);
                        }
                        ...
                        if (branchresttdes == null)
                        {
                            ...
                            branchresttdes = new BranchRestTDES
                            {
                                ...
                                ART_ARTICLE_NR = salebasketarticleTDES.ExternArticle,
                                SUP_TEXT = salebasketarticleTDES.ExternBrandNic,
                                ExternArticleEAN = salebasketarticleTDES.ExternArticleEAN,
                                ArtAmount = 0,
                        ...
                        try
                        {
                            using (TransactionScope transactionScope = new TransactionScope())
                            {
                                ...
                                Item.IsPaid = true;
                                Item.PaidAt = PaymentDate;
                                salebasketarticleTDES.ReverseAmount += Item.ArtAmount;
                                dbSales.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> MakeReverse(Guid? searchRetBasketGuid = default(Guid?), Guid? searchEntGuid = default(Guid?), Guid? searchEntBranchGuid = default(Guid?))
        {
            UserIsInRoles();
            string searchEntUserNic = null;
            if ((!base.ViewBag.IsEcoSystemAdmin))
                    ...
                    else
                    {
                        ...
                        try
                        {
                            using (TransactionScope transactionScope = new TransactionScope())
                            {
                                ...
                                salebasketarticleTDES.ReverseAmount = salebasketarticleTDES.ReverseAmount - Item.ArtAmount + Item.ReverseAmount;
                                branchresttdes.LastUpdated = PaymentDate;
                                Item.IsPaid = true;
                                Item.PaidAt = PaymentDate;
        ...
        [ValidateAntiForgeryToken]
        [HttpPost]
        public async Task<ActionResult> MakePaymentOrReverse(Guid? searchRetBasketGuid = default(Guid?), Guid? searchEntGuid = default(Guid?), Guid? searchEntBranchGuid = default(Guid?), string MAKEPAYMENT = null, string MAKEREVERSE = null)
        {
            if (MAKEPAYMENT != null)
            {
                return await MakePayment(searchRetBasketGuid, searchEntGuid, searchEntBranchGuid);
            }
            return await MakeReverse(searchRetBasketGuid, searchEntGuid, searchEntBranchGuid);
        }
