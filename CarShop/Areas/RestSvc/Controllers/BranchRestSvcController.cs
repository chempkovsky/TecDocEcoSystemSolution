// CarShop.Areas.RestSvc.Controllers.BranchRestSvcController
...
namespace CarShop.Areas.RestSvc.Controllers
{
    ...
    public class BranchRestSvcController : ApiController
    {
        ...
        [HttpPut]
        [Authorize(Roles = "EcoSystemAdmin,EnterpriseAdmin,BranchAdmin,BranchSeller,BranchBooker")]
        public HttpResponseMessage PutBranchRestTDES(Guid? searchEntBranchGuid = null, string searchEntBranchArticle = null, string searchEntBranchSup = null, BranchRestTmp branchresttdes = null)
        {
            if (branchresttdes == null)
            {
                base.ModelState.AddModelError("", Resources.BranchRestTDES_NOTDEFINED);
            }
            if (!base.ModelState.IsValid)
            {
                return base.Request.CreateErrorResponse(HttpStatusCode.BadRequest, base.ModelState);
            ...
            if (!searchEntBranchGuid.HasValue || string.IsNullOrEmpty(searchEntBranchArticle) || string.IsNullOrEmpty(searchEntBranchSup))
            {
                return base.Request.CreateResponse(HttpStatusCode.BadRequest);
            }
            if (searchEntBranchGuid.Value != branchresttdes.EntBranchGuid || searchEntBranchArticle != branchresttdes.EntBranchArticle || searchEntBranchSup != branchresttdes.EntBranchSup)
            {
                return base.Request.CreateResponse(HttpStatusCode.BadRequest);
            }
            ...
            branchRestTDES.TSConcClmn = branchresttdes.TSConcClmn;
        ...
        [HttpDelete]
        [Authorize(Roles = "EcoSystemAdmin,EnterpriseAdmin,BranchAdmin,BranchSeller,BranchBooker")]
        public HttpResponseMessage DeleteBranchRestTDES(Guid? searchEntBranchGuid = null, string searchEntBranchArticle = null, string searchEntBranchSup = null)
        {
            Guid? searchEntGuid = null;
            UserIsInRoles();
            EnterpriseBranchIdsTDES enterpriseBranchIdsTDES = null;
        ...
        public HttpResponseMessage PostBranchRestTDES(BranchRestTmp branchresttdes)
        {
            ...
            branchresttdes.EntBranchGuid = searchEntBranchGuid.Value;
            BranchRestArticleDescriptionTDES branchRestArticleDescriptionTDES = null;
            BranchRestTDES branchRestTDES = (from e in dbRest.BranchRestTDES.Include("BranchRestArticleDescriptionTDES")
