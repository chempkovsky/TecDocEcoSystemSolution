...
/// </summary>
        ...
        [StringLength(60)]
        [Display(ResourceType = typeof(Resources), Name = "SaleBasketTDES_Description")]
...
///
        ...
        [Required]
        [Display(ResourceType = typeof(Resources), Name = "SaleBasketTDES_CreatedAt")]
        ...
        [Required]
        [Display(ResourceType = typeof(Resources), Name = "SaleBasketTDES_ArtAmount")]
        public int ArtAmount { get; set; }

        [Required]
        [Display(ResourceType = typeof(Resources), Name = "SaleBasketTDES_PaymentSum")]
        public Double PaymentSum { get; set; }


        public virtual ICollection<SaleBasketArticleTDES> SaleBasketArticleTDES { get; set; }
